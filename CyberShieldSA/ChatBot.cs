...
namespace CyberShieldSA
{
    public class ChatBot
    {
        ...
        public void StartChat()
        {
            ...
            // Show a daily tip automatically at startup
            ShowDailyTip();
        ...
        // Displays a randomly selected cybersecurity tip automatically when the session starts
        private void ShowDailyTip()
        {
            string[] dailyTips =
            {
                ...
                "Avoid logging into accounts on public WiFi.",
                "Install antivirus software on your computer.",
                "Back up your data regularly to prevent loss from ransomware.",
                "Use a password manager to keep your credentials safe."
            };

            string selectedTip = dailyTips[rand.Next(dailyTips.Length)];
